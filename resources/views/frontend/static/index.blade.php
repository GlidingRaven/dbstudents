...
@section('content')
    <div class="jumbotron">
        <h1>Open Students</h1>
        <p class="lead">Храним и находим информацию о студентах российских университетов</p>
    </div>
      ...
      <div class="well faq_a" style="display: none;">
        <div class="row">
          ...
          <div class="col-md-4 col-md-offset-2">
            <input class="form-control input-lg" maxlength="16" type="text" id="vuz" onkeypress="fullautokey(event)" placeholder="Краткое название университета">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-md-offset-2">
          <h2>Города</h2>
          <p>Список университетов по городам</p>
          <p><a class="btn btn-default" href="/citys" role="button">Посмотреть &raquo;</a></p>
        </div>
        <div class="col-md-3 col-md-offset-2">
          <h2>Университеты</h2>
          <p>Все топовые университеты страны</p>
          <p><a class="btn btn-default" href="/campuses" role="button">Узнать &raquo;</a></p>
       </div>
      </div>
